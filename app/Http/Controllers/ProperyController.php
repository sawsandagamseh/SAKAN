...
class ProperyController extends Controller
{
    ...
    {
        $allproperties = Propery::paginate(10);
       

        return view("dash.admin_my_listings", compact('allproperties'));
    ...
    return redirect()->route('property.index')->with('success', 'Category updated successfully');
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Propery $home)
    {
        //
    }
}
