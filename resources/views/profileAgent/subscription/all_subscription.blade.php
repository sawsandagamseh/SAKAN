                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 royal-add-property-area section_100 pl-0 user-dash2">
                        ...
                        <div class="my-properties">
                            <div class="row">
                                <div class="col-lg-9 col-md-12 col-xs-12 pl-0 user-dash2">
                                    <a class="btn btn-common" href="{{ route('payment_agent.index') }}"><i
                                            class="lni-chevron-left"></i> Add Property</a>
                                </div>
                            </div>
                            <br>
                            <table class="table-responsive">
                                ...
                                <tbody>
                                    @foreach ($allsub as $oneSubscription)
                                        <tr>
                                            <td class="image myelist">
                                                <h2> {{ $oneSubscription->name }}</h2>
                                            </td>
                                            <td>
                                                {{ $oneSubscription->rule1 }}
                                            </td>
                                            <td> {{ $oneSubscription->rule2 }}</td>
                                            <td> {{ $oneSubscription->number_of_days }}</td>
                                            <td>{{ $oneSubscription->property_1 }}</td>
                                            <td>{{ $oneSubscription->property_5 }}</td>
                                            <td>{{ $oneSubscription->property_10 }}</td>
                                            <td>{{ $oneSubscription->property_20 }}</td>
                                            <td>{{ $oneSubscription->property_50 }}</td>
                        ...
                        <div class="dashborad-box mb-0">
                            <h4 class="heading pt-0">Purchase Subscription</h4>
                            ...
                            <div class="section-inforamation">
                                    ...
                                    <div class="password-section">
                                        <form method="post" action="{{ route('purchaseSubscribe') }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="subscription_id" id="subscription_id"
                                                            class="form-control">
                                                            @foreach ($allsub as $subscription)
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="property_number" id="subscription"
                                                            class="form-control">

                                                            <option value="property_1" selected>1 Property</option>
                                                            <option value="property_5">5 Property</option>

                                                            <option value="property_10">10 Property</option>
                                                            <option value="property_20">20 Property</option>
                                                            <option value="property_50">50 property</option>
