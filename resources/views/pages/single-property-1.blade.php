            ...
            <div id="header">
                <div class="container container-header">
                    ...
                    <div class="left-side">
                        <!-- Logo -->
                        <div id="logo">
                            <a href="index.html"><img src="{{ asset('images/logo-red.svg.jpg') }}" alt=""></a>
                        </div>
                        <!-- Mobile Navigation -->
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12 blog-pots">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="pro-wrapper">
                                        <div class="detail-wrapper-body">
                                            <div class="listing-title-bar">
                                                <h3>{{ $singleproperty->name }}<span class="mrg-l-5 category-tag">For
                                                        Rent </span></h3>
                                                <div class="mt-0">
                                                    <a href="#listing-location" class="listing-address">
                                                        <i class="fa fa-map-marker pr-2 ti-location-pin mrg-r-5"></i>77
                                                        - {{ $singleproperty->area_name }}
                                                        ,{{ $singleproperty->district }}, {{ $singleproperty->city }}
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="listingDetailsSlider" class="carousel listing-details-sliders slide mb-30">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="active item carousel-item" data-slide-number="0">
                                            <img src="{{ asset('images/single-property/s-1.jpg') }}"
                                                class="img-fluid" alt="slider-listing">
                                        </div>
                                        <div class="item carousel-item" data-slide-number="1">
                                            <img src="{{ asset('images/single-property/s-2.jpg') }}"
                                                class="img-fluid" alt="slider-listing">
                                        </div>
                                        <div class="item carousel-item" data-slide-number="2">
                                            <img src="{{ asset('images/single-property/s-3.jpg') }}"
                                                class="img-fluid" alt="slider-listing">
                                        </div>
                                        <div class="item carousel-item" data-slide-number="4">
                                            <img src="{{ asset('images/single-property/s-4.jpg') }}"
                                                class="img-fluid" alt="slider-listing">
                                        </div>
                                        <div class="item carousel-item" data-slide-number="5">
                                            <img src="{{ asset('images/single-property/s-5.jpg') }}"
                                                class="img-fluid" alt="slider-listing">
                                        </div>
                                ...
                                <div class="blog-info details mb-30">
                                    ...
                                    <p class="mb-3">{{ $singleproperty->description }}</p>
                        ...
                        <div class="single homes-content details mb-30">
                            ...
                            <ul class="homes-list clearfix">
                                ...
                                <li>
                                    ...
                                    <span class="det">{{ $singleproperty->description }} /month</span>
                                </li>
                                <li>
                                    <span class="font-weight-bold mr-1">Rooms:</span>
                                    <span class="det">{{ $singleproperty->room_number }}</span>
                                </li>
                                <li>
                                    <span class="font-weight-bold mr-1">Bedrooms:</span>
                                    <span class="det">{{ $singleproperty->bedroom_number }}</span>
                                </li>
                                <li>
                                    <span class="font-weight-bold mr-1">Bath:</span>
                                    <span class="det">{{ $singleproperty->bath_number }}</span>
                                </li>
                                <li>
                                    <span class="font-weight-bold mr-1">Garages:</span>
                                    <span class="det">{{ $singleproperty->carage_number }}</span>
                                </li>
                                <li>
                                    <span class="font-weight-bold mr-1">Age:</span>
                                    <span class="det">{{ $singleproperty->Age }}</span>
                                </li>
                            </ul>
                            <!-- title -->
                        ...
                        <div class="floor-plan property wprt-image-video w50 pro">
                            <h5>Floor Plans</h5>
                            <img alt="image" src="{{ asset('images/bg/floor-plan-1.png') }}">
                        </div>
                        <div class="floor-plan property wprt-image-video w50 pro">
                            <h5>What's Nearby</h5>
                        ...
                        <section class="reviews comments">
                            ...
                            <div class="row mb-5">
                                <ul class="col-12 commented pl-0">
                                    <li class="comm-inf">
                                        <div class="col-md-2">
                                            <img src="{{ asset('images/testimonials/ts-5.jpg') }}" class="img-fluid"
                                                alt="">
                                        </div>
                                        <div class="col-md-10 comments-info">
                                            ...
                                            <p>When it comes to home listings, words are only part of the story.
                                                Professional-quality staging photos also are essential to increasing
                                                consumer interest, and should be considered an integral component of
                                                your listing description.</p>
                                            <div class="rest"><img
                                                    src="{{ asset('images/single-property/s-1.jpg') }}"
                    ...
                    <aside class="col-lg-4 col-md-12 car">
                        <div class="single widget">
                            ...
                            <div class="schedule widget-boxed mt-33 mt-0">
                                ...
                                <form name="contact_form" method="POST" action="{{ route('apointmentStore') }}"
                                    ...
                                    <div class="widget-boxed-body">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-12 book">
                                                <input type="text" id="reservation-date" name="date"
                                                    data-lang="en" data-large-mode="true" data-min-year="2017"
                                                    data-max-year="2020" data-disabled-days="08/17/2017,08/18/2017"
                                                    data-id="datedropper-0" data-theme="my-style"
                                                    class="form-control" readonly="">
                                            </div>
                                            <div class="col-lg-6 col-md-12 book2">
                                                <input type="text" id="reservation-time" name="houre"
                                                    class="form-control" readonly="">
                                            </div>
                                            {{-- <input type="date"  name="date"> 
                                            <input type="time"  name="houre">   --}}
                                        </div>
                                            ...
                                            <div class="agent-contact-form-sidebar">
                                                ...
                                                <div class="sidebar-widget author-widget2">
                                                    ...
                                                    <div class="agent-contact-form-sidebar">
                                                        ...
                                                        <input type="text" id="pnumber" name="phone"
                                                            placeholder="Phone Number" required />
                                                        <input type="email" id="emailid" name="email"
                                                            placeholder="Email Address" required />
                                                        @auth
                                                            <!-- User is authenticated, include user_id as a hidden input field -->
                                                        ...
                                                        <input type="hidden" id="property_id" name="property_id"
                                                            value="{{ $singleproperty->id }}" required />
                    ...
                    <div class="agent-contact-form-sidebar">
                        ...
                        <form name="contact_form" method="post"
                            ...
                            <input type="text" id="fname" name="full_name" placeholder="Full Name"
                                required />
                            <input type="text" id="pnumber" name="phone" placeholder="Phone Number"
                                required />
                ...
                <div class="widget-boxed-body">
                    <div class="recent-post">
                        <div class="recent-main">
                            <div class="recent-img">
                                <a href="blog-details.html"><img
                                        src="{{ asset('images/feature-properties/fp-1.jpg') }}" alt=""></a>
                            </div>
                            <div class="info-img">
                        ...
                        <div class="recent-main my-4">
                            <div class="recent-img">
                                <a href="blog-details.html"><img
                                        src="{{ asset('images/feature-properties/fp-2.jpg') }}" alt=""></a>
                            </div>
                            <div class="info-img">
                                <a href="blog-details.html">
                                    <h6>Family Home</h6>
                        ...
                        <div class="recent-main">
                            <div class="recent-img">
                                <a href="blog-details.html"><img
                                        src="{{ asset('images/feature-properties/fp-3.jpg') }}" alt=""></a>
                            </div>
                            <div class="info-img">
                                <a href="blog-details.html">
                                    <h6>Family Home</h6>
                        ...
                        <div class="agents-grid mr-0">
                            <div class="listing-item compact">
                                <a href="properties-details.html" class="listing-img-container">
                                    ...
                                    <img src="{{ asset('images/feature-properties/fp-1.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="agents-grid mr-0">
                            <div class="listing-item compact">
                                <a href="properties-details.html" class="listing-img-container">
                                    ...
                                    <img src="{{ asset('images/feature-properties/fp-2.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="agents-grid mr-0">
                            <div class="listing-item compact">
                                <a href="properties-details.html" class="listing-img-container">
                                    ...
                                    <img src="{{ asset('images/feature-properties/fp-3.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="agents-grid mr-0">
                            <div class="listing-item compact">
                                <a href="properties-details.html" class="listing-img-container">
                                    ...
                                    <img src="{{ asset('images/feature-properties/fp-4.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="agents-grid mr-0">
                            <div class="listing-item compact">
                                <a href="properties-details.html" class="listing-img-container">
                                    ...
                                    <img src="{{ asset('images/feature-properties/fp-5.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="agents-grid mr-0">
                            <div class="listing-item compact">
                                <a href="properties-details.html" class="listing-img-container">
                                    ...
                                    <img src="{{ asset('images/feature-properties/fp-6.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-inner project-head">
                            <div class="homes">
                                ...
                                <a href="single-property-1.html" class="homes-img">
                                    ...
                                    <img src="{{ asset('images/blog/b-11.jpg') }}" alt="home-1"
                ...
                <div class="item col-lg-4 col-md-6 col-xs-12 people">
                    <div class="project-single">
                        <div class="project-inner project-head">
                            <div class="homes">
                                ...
                                <a href="single-property-1.html" class="homes-img">
                                    ...
                                    <img src="{{ asset('images/blog/b-12.jpg') }}" alt="home-1"
                                        class="img-responsive">
                                </a>
                            </div>
                            <div class="button-effect">
                        ...
                        <div class="homes-content">
                            ...
                            <div class="footer">
                                <a href="agent-details.html">
                                    <img src="{{ asset('images/testimonials/ts-2.jpg') }}" alt=""
                        ...
                        <div class="project-inner project-head">
                            <div class="homes">
                                ...
                                <a href="single-property-1.html" class="homes-img">
                                    <div class="homes-tag button alt sale">For Sale</div>
                                    <div class="homes-price">$9,000/mo</div>
                                    <img src="{{ asset('images/blog/b-1.jpg') }}" alt="home-1"
                                        class="img-responsive">
                                </a>
                            </div>
                            <div class="button-effect">
                            ...
                            <div class="twitter-widget contuct">
                                <div class="twitter-area">
                                    ...
                                    <div class="single-item">
                                        ...
                                        <div class="text">
                                            <h5><a href="#">@sakan</a> Dear customer, here you will find your
                                                convenience
                                                .</h5>
