{{-- <x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="roles" class="block mt-1 w-full" type="text" name="roles" :value="old('roles')" required autofocus autocomplete="roles" />
        ...
        <div id="login">
            <div class="login">
                <form autocomplete="off" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        <label>role *</label>
                        <input name="roles" type="text" class="form-control"  id="roles" value="">
