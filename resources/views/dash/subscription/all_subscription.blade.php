                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 royal-add-property-area section_100 pl-0 user-dash2">
                        ...
                        <div class="my-properties">
                            <div class="row">
                                ...
                                <a class="btn btn-common" href="{{ route('subscription.create') }}"><i class="lni-chevron-left"></i> Add Property</a> 
                                </div>
                            </div>
                            <br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="image myelist">
                                            <h2> {{$allsub->name}}</h2>                                        </td>
                                        <td>
                                            {{ $allsub->rule1}}
                                        </td>
                                        <td> {{ $allsub->rule2}}</td>
                                        <td> {{ $allsub->number_of_days}}</td>
                                        <td>{{ $allsub->property_1}}</td>
                                        <td>{{ $allsub->property_5}}</td>
                                        <td>{{ $allsub->property_10}}</td>
                                        <td>{{ $allsub->property_20}}</td>
                                        <td>{{ $allsub->property_50}}</td>
                                        
                                        <td class="actions">
                                            <a href="" class="edit"><i class="lni-pencil"></i>Edit</a>
                                            <form method="POST" action="{{ route('subscription.destroy', $allsub->id) }}" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
