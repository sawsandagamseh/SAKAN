                ...
                <div class="col-lg-9 col-md-12 col-xs-12 pl-0 user-dash2">
                            ...
                            <div class="messages">
                                <div class="message">
                                    ...
                                    <div class="body">
                                        ...
                                        <p class="content mb-0 mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing
                    ...
                    <div class="dashborad-box mb-0">
                        ...
                        <div class="section-inforamation">
                            <form method="post" action="{{ route('dashboard_admin.update', $admin->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" placeholder="Ex: +1-800-7700-00"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Write about userself"
                                                name="about" value="{{ $admin->about }}">
                                    ...
                                    {{-- <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control"
                                                    placeholder="Write new password" name="password">
                                                <span style="color:red">
                                                    @error('password')
                                                        {{ $message }}
                                                    @enderror
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control"
                                                    placeholder="Write same password again" name="password_confirmation">
                                                <span style="color:red">
