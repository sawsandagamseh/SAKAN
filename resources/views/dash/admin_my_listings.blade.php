                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 pl-0 user-dash2">
                       ...
                       <div class="col-lg-12 mobile-dashbord dashbord">
                        ...
                        <div class="my-properties">
                            <div class="row">
                                <div class="col-lg-9 col-md-12 col-xs-12 pl-0 user-dash2">
                                <a class="btn btn-common" href="{{ route('property.create') }}"><i class="lni-chevron-left"></i> Add Property</a> 
                                </div>
                            </div>
                            <br>
                            <table class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                            <a href="{{ route('property.edit',$allproperty->id) }}" class="edit"><i class="lni-pencil"></i>Edit</a>
